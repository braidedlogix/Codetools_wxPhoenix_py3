...
def map_keys(f, d):
    ''' Map a function over the keys in a dictionary.
        ...
        True
    '''
    return dict([(f(k), v) for k, v in list(d.items())])
...
def filter_keys(p, d):
    ''' Filter a dictionary by a predicate on keys.
        ...
        True
    '''
    return dict([(k, v) for k, v in list(d.items()) if p(k)])
...
def filter_values(p, d):
    ''' Filter a dictionary by a predicate on values.
        ...
        True
    '''
    return dict([(k, v) for k, v in list(d.items()) if p(v)])
...
def filter_items(p, d):
    ''' Filter a dictionary by a predicate on key-value pairs.
        ...
        True
    '''
    return dict([(k, v) for k, v in list(d.items()) if p(k, v)])
