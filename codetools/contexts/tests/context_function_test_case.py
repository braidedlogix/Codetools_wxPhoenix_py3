...
class ContextFunctionTestCase(unittest.TestCase):
    ...
    def test_star_and_kw_args(self):
        ...
        kwarg = dict(a=a, b=2, c=3, d=4, e=5)
        self.assertEqual(
            star_and_kw_args(**kwarg), context_star_and_kw_args(**kwarg))
        arg = (a, 2, 3)
        kwarg = dict(d=4, e=5)
        self.assertEqual(
            star_and_kw_args(*arg, **kwarg),
            context_star_and_kw_args(*arg, **kwarg))
        arg = (2, 3)
        kwarg = dict(d=4, e=5)
        self.assertEqual(
            star_and_kw_args(a, *arg, **kwarg),
